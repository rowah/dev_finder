defmodule DevFinderWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DevFinderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DevFinderWeb.Gettext, "errors", msg, opts)
    end
  end
